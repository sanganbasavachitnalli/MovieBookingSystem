...
<script>
	fun1();
	function fun1(){
		document.getElementById("seat").style.disabled="true";
	}
...
<body>
	...
	%>
		...
		<form action="userbooking.jsp" method="post" >
			<table>
				<tr>
                        <td></td>
                        <td>1</td>
...
<div class="screen">
              ...
              <input type="submit" class="sbut" value="Back" id="Sbut"  style="cursor:pointer;">
