...
<body>
	<div id="hode">
	 <ul class="seat_w3ls">
		...
		<a href="adminhome.jsp" class="header-btn" style="font-size:15px"><u>Home</u></a>
	...
	%>
		...
		<form action="admintheatreticker.jsp" method="post" >
			<table>
				<tr>
                        <td></td>
                        <td>1</td>
			...
			<div class="screen">
              ...
              <input type="submit" class="sbut" value="GO Back" id="Sbut" name="amount" style="cursor:pointer;">
